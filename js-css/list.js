...
function ajouter(data){
    ...
    if (!exist(data)){
        ...
        total.innerHTML = parseFloat(prodprix)+' TND'
        gTotal.innerHTML =  parseFloat(gTotal.innerText)+parseFloat(total.innerText)+' TND';
        ...
        total.innerHTML = parseFloat(total.innerText)+parseFloat(prix.innerText)+ ' TND';
        gTotal.innerHTML =  parseFloat(gTotal.innerText)+parseFloat(prix.innerText)+' TND';
    }
}
...
function supprimer(data){
    ...
    if (quantite.innerText=='1'){
        ...
        gTotal.innerHTML = parseFloat(gTotal.innerText)-parseFloat(totaln.innerText)+' TND';
        const nbrProdits = document.getElementById('nbr-produits')
        nbrProdits.innerHTML =  parseFloat(nbrProdits.innerText)-1;
        ...
        const gTotal = document.getElementById('global-total')
        const totaln = document.getElementById('total'+data)
        totaln.innerHTML = parseFloat(totaln.innerText)-parseFloat(prix.innerText)+ ' TND';
        gTotal.innerHTML = parseFloat(gTotal.innerText)-parseFloat(prix.innerText)+ ' TND';
        quantite.innerHTML = Number(quantite.innerText)-1
    }
}